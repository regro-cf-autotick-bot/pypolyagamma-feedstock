...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/pypolyagamma-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pypolyagamma-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add pypolyagamma
# for installing globally
pixi global install pypolyagamma
```
...
It is possible to list all of the versions of `pypolyagamma` available on your platform:
...
```
pixi search pypolyagamma --channel conda-forge
```
